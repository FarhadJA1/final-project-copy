...
function ClassroomDeleteBtn(props) {
    ...
    return (
        <div>
            <Tooltip title={t("delete classroom")} placement="bottom-end">
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            {t("are you sure to permanently delete this classroom?")}
                        </div>
                        <div className="modal-footer">
                            <button onClick={() => props.deleteClassroom()} data-bs-dismiss="modal" type="button" className="btn btn-outline-danger classroom-button">{t("delete")}</button>
